...
/**
 * Retry policy with exponential backoff and jitter for Adobe Sign API calls.
...
public class RetryPolicy {
     ...
     */
    public <T> T execute(Callable<T> action) throws AdobeSignException {
        int attempt = 0;
        while (true) {
            try {
                return action.call();
                ...
                throw new AdobeSignException("Unexpected error during API call", e);
            }
        }
    }
